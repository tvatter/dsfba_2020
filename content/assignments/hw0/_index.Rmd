...
In this optional tutorial you'll get an overview of the basic programming concepts in R and main data types. Just enough to get you up and running essenial R code. However, for true "beginners", we highly recommend going through [Advanced R - Chapter 'Foundations'](http://adv-r.had.co.nz/Data-structures.html) from which the content of this assignment is mainly (mostly) inspired by. 
...
In R, we assign values (numbers, characters, data frames) to objects (vectors, matricies, variables).
